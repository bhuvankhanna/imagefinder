...
public class Output extends javax.swing.JDialog {
    ...
    public Output(ImageQuery parent) {
        ...
        maxWith = parent.lmOutCol.size();
        maxWithout = parent.lmOutGS.size();
        ...
        jLabelMain.setText("RESULT RETREIVED IN: " + parent.timeTaken + " milliSecs.");
        
        loadImages();
    }
    
    public void withToFirst() {
        maxWith = parent.lmOutCol.size();
        if(maxWith == 0) {
            currIndexWith = -1;
        }else {
    ...
    public void withToLast() {
        maxWith = parent.lmOutCol.size();
        if(maxWith == 0) {
            currIndexWith = -1;
        }else {
            currIndexWith = maxWith-1;
        }
        loadImages();
    }
    
    public void withoutToFirst() {
        maxWithout = parent.lmOutGS.size();
        if(maxWithout == 0) {
            currIndexWithout = -1;
        }else {
    ...
    public void withoutToLast() {
        maxWithout = parent.lmOutGS.size();
        if(maxWithout == 0) {
            currIndexWithout = -1;
        }else {
            currIndexWithout = maxWithout-1;
        }
        loadImages();
    }
    ...
    private void initComponents() {
        ...
        jButton8.setFont(new java.awt.Font("Arial Black", 1, 14));
        jButton8.setText(">");
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .add(jPanel8Layout.createSequentialGroup()
                ...
                .add(jPanel8Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    ...
                    .add(jLabelWith0, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                ...
                .add(jPanel8Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    ...
                    .add(jLabelWith5, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel8Layout.linkSize(new java.awt.Component[] {jButton1, jButton4, jButton5, jButton8}, org.jdesktop.layout.GroupLayout.VERTICAL);
        ...
        jLabelMain.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        ...
        jButton7.setFont(new java.awt.Font("Arial Black", 1, 14));
        jButton7.setText("> > > >");
        ...
        jButton9.setFont(new java.awt.Font("Arial Black", 1, 14));
        jButton9.setText(">");
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .add(jPanel9Layout.createSequentialGroup()
                ...
                .add(jPanel9Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    ...
                    .add(jLabelWithout0, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                ...
                .add(jPanel9Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    ...
                    .add(jLabelWithout5, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel9Layout.linkSize(new java.awt.Component[] {jButton2, jButton6, jButton7, jButton9}, org.jdesktop.layout.GroupLayout.VERTICAL);
...
// TODO add your handling code here:
        if(currIndexWithout == -1) {
            return;
        }
        
        if(currIndexWithout < (maxWithout-1)) {
            currIndexWithout++;
            loadImages();
        }        
